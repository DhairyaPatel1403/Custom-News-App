...
def st_custom_slider(label: str, min_value: int, max_value: int, label2: str, news):
    component_value = _component_func(label=label, minValue=min_value, maxValue=max_value, label2=label2, news=news)
    return component_value